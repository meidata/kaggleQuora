...
if __name__ == '__main__':
    ...
    y = np.array(np.nan_to_num(np.load(path_feature +'train_is_duplicate.npy')))
    X = np.array(np.nan_to_num(np.load(path_feature +'train_feature_with_intersec_no_hash.npy')))
    X_submission = np.array(np.nan_to_num(np.load(path_feature +'test_feature_with_intersec_no_hash.npy'))) 
